...
namespace HoozOn.Migrations
{
    ...
    [Migration("20220726144609_SetsAdmin")]
    partial class SetsAdmin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Control.SetJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Entities.Control.Sets", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HoozOn.Entities.Job.UserJobListModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Entities.Control.SetJob", b =>
                {
                    ...
                    b.HasOne("API.Entities.Control.Sets", "Set")
                        .WithMany()
                        .HasForeignKey("SetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
